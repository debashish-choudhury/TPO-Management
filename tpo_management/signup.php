...
<body>
    ...
    <div class="recruiter-slider">
        ...
        <div  style="position: fixed; background-color: #f2f2f2; opacity: 0.9" class="signup-box">
            <h2 style="color: black;">Sign Up</h2><br><br>
        <!-- <h3><a href="recruitersignup.php">Recruiter Sign Up Page</a></h3> -->
        <h3><a href="studsignup.php">Student Sign Up Page</a></h3>
        </div>
    </div>
</body>    
</html>